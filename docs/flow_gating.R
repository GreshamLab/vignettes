...
#
#started: 01/07/2016
#modified: 2/14/2019 by NB
#modified 1/10/2020 by DG
#
...
#
#Individual gates are saved in a file gates.Rdata for use with downstream flow anlaysis pipelines
###########################################################################################################################

##To be run the first time if packages have not previously been installed.
...
#load sample sheet
sample.sheet <- read.csv(paste(path.data,"/sample_sheet",".csv", sep=""))
